...
\author[Peter YU]
{
Presenter：Zhouwei YU\\
Tutor：Prof. Tong Hao \\
}
\institute[Tongji UIS]
{\textbf{同济大学\quad 地下基础设施空间课题组}\\
Underground Infrastructure Space,Tongji University}
...
\begin{frame}{Subfigure}
    \begin{figure}
        \centering
        \subfigure[]{\includegraphics[width=0.47\textwidth]{tj_logo.jpg}}
        \subfigure[]{\includegraphics[width=0.47\textwidth]{tjbackground2.jpg}}
...
\begin{frame}{参考文献} %[allowframebreaks]
\bibliography{slides}
